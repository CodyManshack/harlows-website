...
export default defineNuxtConfig({
  ...
  app: {
    head: {
      ...
      script: [
        { src: 'https://www.googletagmanager.com/gtag/js?id=G-XPGV6LMGBP', async: true },
        { src: 'https://www.googletagmanager.com/gtag/js?id=G-7P9L9NMVJD', async: true },
        {
