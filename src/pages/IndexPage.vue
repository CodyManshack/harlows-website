<template>
  <q-page class="cool-background">
    <div class="column justify-center items-center landing-hero">
      <h1 class="poiret-one no-margin text-white text-center text-shadow">HARLOW<span>'</span>s</h1>
      <DiamondDivider style="width: 540px;"/>
      <q-list dark class="q-mt-md">
        ...
        <q-expansion-item hide-expand-icon>
          ...
          <div class="q-pa-md">
            <q-btn flat label="Instagram" icon="ion-logo-instagram"/>
            <q-btn flat label="Facebook" icon="ion-logo-facebook"/>
            <q-btn flat label="Twitter" icon="ion-logo-twitter"/>
          </div>
        </q-expansion-item>
      </q-list>
    </div>
